...
function initRuntimeSocketService() {
  const hosts = "192.168.31.253,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_PjuHj5";
...
const pages = [
  {
    ...
    style: {
      navigationBarBackgroundColor: "#313446",
  ...
  },
  {
    ...
    style: {
      ...
      customTabBar: "components/CustomTabBar",
      "app-plus": {
        titleNView: {
          buttons: [
            {
    ...
    }
    {
      ...
      if (!index$1.__stat_uniCloud_space) {
        if (space && Object.keys(space).length !== 0) {
          ...
          index$1.__stat_uniCloud_space = er.init(spaceData);
        } else {
